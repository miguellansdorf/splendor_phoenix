    ...
    <div class="p-1 flex flex-col gap-1 rounded-lg border-2 items-center select-none">
      ...
      <div class="flex gap-1 items-center">
        <div
          ...
          class={[
            "rounded-full px-1 xl:px-2 size-5 xl:size-8 flex items-center justify-center text-xs xl:text-lg font-bold text-black",
      ...
      <div class="flex gap-1 items-center">
        <div
          ...
          class={[
            "rounded-sm w-4 h-6 xl:w-8 xl:h-10 flex items-center justify-center text-xs xl:text-lg font-bold text-black",
            attribute_bg(attribute)
          ]}
        >
      ...
      <div class="flex gap-1 items-center">
        <div
          :for={reservation <- @player.reservations}
          class="rounded-sm w-4 h-6 xl:w-8 xl:h-10 bg-amber-500"
        >
        </div>
        <div
          :for={_ <- Range.new(1, 3 - length(@player.reservations), 1)}
          class="rounded-sm w-4 h-6 xl:w-8 xl:h-10 border border-dotted border-amber-500"
        >
        </div>
      </div>
    </div>
    ...
    <div class="size-32 xl:size-44 border-2 xl:border-4 border-amber-800 rounded-lg overflow-hidden flex flex-col-reverse items-center relative select-none group-hover:border-amber-500 group-hover:cursor-pointer">
      ...
      <div class="flex gap-1">
        ...
        >
          ...
          <span class="text-sm xl:text-lg text-white font-bold">
            {Map.get(@noble.cost, attribute)}
          </span>
        </div>
      </div>
    </div>
